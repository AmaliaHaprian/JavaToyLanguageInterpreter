...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl, MyIList<Value> ot, IStmt prg, MyIDictionary<StringValue, BufferedReader> fileTable, IHeap<Integer,Value> heap, ISemaphoreTable<Integer, Pair<Integer, ArrayList<Integer>>> semaphoreTable) throws MyException {
        this.exeStack = stk;
    ...
    public String toString() {
       ...
       // s+=stk.toString();
        ...
        ISemaphoreTable<Integer, Pair<Integer, ArrayList<Integer>>> semaphoreTable=this.getSemaphoreTable();
        s+="\t    SemaphoreTable:\n";
